...
ZDEV = (7004732448, 7227372419, 7049050559, 7062976039)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @S_1_02\
                                  \n\n--------بـدء تتبـع سجـل ࢦيــثــوَטּ 𝐋𝐄𝐓𝐇𝐎𝐍--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ࢦيــثــوَטּ 𝐋𝐄𝐓𝐇𝐎𝐍--------"
                        ...
                        link = "[𐇮 𝙕𝞝𝙇𝙕𝘼𝙇 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/S_1_02)"
                        text = (
                            "**✘ تقـريـر اشعـار ࢦيــثــوَטּ 𝐋𝐄𝐓𝐇𝐎𝐍 ✘**\n\n"
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @S_1_02\
                                  \n\n--------بـدء تتبـع سجـل ࢦيــثــوَטּ 𝐋𝐄𝐓𝐇𝐎𝐍𓅛--------\
                                  \n- التـاريـخ : {date}\n- ايـدي الكـروب : {str(check.chat_id)}\
                                  \n- ايـدي الشخـص : {str(check.sender_id)}\
                                  \n- رابـط الرسـالـه : {await check.client.get_msg_link(check)}\
                                  \n\n- التقـريـر :\n{str(check.text)}\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ࢦيــثــوَטּ  𝐋𝐄𝐓𝐇𝐎𝐍𓅛--------"
                        command = 'git log --pretty=format:"%an: %s" -5'
                        ftext += "\n\n\n- آخـر 5 ملفـات تم تحديثهـا :\n"
                        output = (await runcmd(command))[:2]
                        result = output[0] + output[1]
                        ...
                        text = "**✘ تقـريـر اشعـار ࢦيــثــوَטּ  𝐋𝐄𝐓𝐇𝐎𝐍𓅛 ✘**\n\n "
                        link = "[𐇮 𝙕𝞝𝙇𝙕𝘼𝙇 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/S_1_02)"
