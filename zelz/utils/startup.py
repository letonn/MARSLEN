...
#< https://t.me/ZThon >
# This file is a part of < https://github.com/letonn/MARSLEN/ >
...
Zed_Vip = (7004732448, 7227372419, 7049050559, 7062976039, 7227372419, 7004732448)
Zed_Dev = (7004732448, 7227372419, 7049050559, 7062976039, 7227372419, 7004732448)
zchannel = {"@A1DIIU", "@grupmtaem", "@SUPERXFAST", "@ll0llld", "@L_Q7I", "@H_8_o", "@WW02_W", "@WW00_W", "@WW06_W", "@E_A_1L"}
...
async def mybot(): #Code by T.me/S_1_02
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت ࢦيــثــوَטּ المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ࢦيــثــوَטּ الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝐋𝐄𝐓𝐇𝐎𝐍𓅛", "https://t.me/A1DIIU"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل  ࢦيــثــوَטּ", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
